...
import { Box, Button, FormControl, FormLabel, Input, Flex, Text, ChakraProvider } from '@chakra-ui/react';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (token) {
                ...
                if (decodedToken && decodedToken.id && decodedToken.email && decodedToken.nome) {
                    handleLogin({ id: decodedToken.id, email: decodedToken.email, nome: decodedToken.nome });
    ...
    return (
        <ChakraProvider theme={theme}>
            <Flex direction='column' alignItems='center' height='100vh' justifyContent='center'>
                ...
                <Box bg='orange.500' p={8} borderRadius='md' boxShadow='md' width='400px'>
                    <form onSubmit={handleSubmit}>
                        ...
                        <Button type='submit' bg='black' color='white' width='full' mt={4} _hover={{ bg: 'gray.700' }}>
                            Acessar
                        </Button>
                    </form>
                    ...
                    <Link href='/cadastrar'>
                        <Button bg='blue.500' color='white' width='full' mt={4} _hover={{ bg: 'blue.700' }}>
                            Cadastrar
                        </Button>
                    </Link>
                </Box>
